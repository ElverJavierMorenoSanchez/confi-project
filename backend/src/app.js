...
import subcategory from "./routes/printer/subcategory.routes";
...
import model from "./routes/computer/model.routes";
...
app.use("/api/printer/subcategory", subcategory);
...
app.use("/api/computer/model", model);
